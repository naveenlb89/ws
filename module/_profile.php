   ...
   <div class="row">
      ...
      <section class="mobile-tab d-md-none">
          <div class="row">
              ...
              <div class="col-7">
                  <div class="details-list"><span class="details">
                      Jennie Doe



                  </span><i class="fas fa-caret-down"></i></div>
              </div>
          </div>
      </section>
      <section class=" profile-tab-left">
          <ul class="nav nav-tabs flex-column d-md-block vertical-tabs-section hide-mobile filter-dropdown-mobile" style="display: none;">
              <li class="nav-item">
                  <a class="nav-link active" href="#userone">
                      <label class="radio-container">Jennie Doe
                          <input type="radio" checked="checked" name="radio" class="d-md-none">
                          <span class="checkmark d-md-none"></span>
                      </label>
                      <span class="d-block payment__user--heading">Versailles, France 2019</span>
                  </a>
              </li>
              <li class="nav-item">
                  <a class="nav-link" href="#usertwo">
                      <label class="radio-container">John Doe
                          <input type="radio" checked="checked" name="radio" class="d-md-none">
                          <span class="checkmark d-md-none"></span>
                      </label>
                      <span class="d-block payment__user--heading">Versailles, France 2019</span>
              ...
              <li class="nav-item">
                  <a class="nav-link" href="#userthree">
                      <label class="radio-container">Jane Doe
                          <input type="radio" checked="checked" name="radio" class="d-md-none">
                          <span class="checkmark d-md-none"></span>
                      </label>
                      <span class="d-block payment__user--heading">Versailles, France 2019</span>
      ...
      <div class="col-md-10 profile-right mb-5">
         <div class="tab-content">
            <div id="userone" class="tab-pane active">
               <section class="profile-tab-content active-tab-content">
                  <div class="profile-head d-none d-md-block clearfix">
                        ...
                        <div class="col-md-12 accordion-div">
                           <div id="accordion" class="accordion">
                              <div class="card mb-0 border-0">
                                 <div id="collapseOne" class="card-body collapse show px-0" data-parent="#accordion">
                                    <!--accordion form-->
                                    <div class="container m-payment-details m-md-0">
                                       <div class="confirmation border-0">
                                          <div class="confirmation-block p-md-0 border-0">
                                             <div class="row mx-md-0">
                                                <div class="row confirmation-traveller-details">
                                                   <div class="col-12 payment-next-details mb-3 mb-md-4 px-lg-0">
                                                      <div class="d-block d-md-flex payment-due--txt py-md-2">
                                                         <p class="col-12 col-md-8 payment-due--txt-header pt-3 pt-md-0">
                                                            Next payment of <span class="txt--bold">$199.00</span> due on <span class="txt--bold">02/28/19: 16 days</span> remaining. Payment in full due on: <span class="txt--bold">05/22/20</span>
                                                         </p>
                                                         <div class="col-12 col-md-4 pt-2 pb-3">
                                                            <button type="button" class="btn btn-primary payment-due--btn">Make A Payment</button>
                                                         </div>
                                                      </div>
                                                   </div>
                                                   <div class="col-12 col-md-8 traveller-details-left confirmation-p-0 pl-md-3 pl-lg-0">
                                                      <div class="traveller payment pb-xl-4">
                                                         <div class="traveller-header clearfix pl-4">
                                                         ...
                                                         <div class="row traveller-block m-0">
                                                            <div class="col-12 px-0 px-md-1">
                                                               <div class="item-order-main px-2">
                                                                  <div class="d-flex item-heading py-xl-2 justify-content-center pb-2 justify-content-lg-start">
                                                                     <div class="col-3 px-1 col-md-3 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Item Name</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Type</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Date</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Billed</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Amount</div>
                                                                  </div>
                                                                  <div class="d-flex item-details py-xl-2 justify-content-center py-2 justify-content-lg-start">
                                                                     <div class="col-3 px-1 col-md-3 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Versailles, France #242543
                                                                        <span class="d-block item-heading--txt--sub">Order #: 1234567</span>
                                                                     </div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">Scheduled Payment</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">02/01/2019</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">01/16/2019</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">$199.00</div>
                                                                  </div>
                                                                  <div class="d-flex item-details py-xl-2 justify-content-center py-2 justify-content-lg-start">
                                                                     <div class="col-3 px-1 col-md-3 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Versailles, France #242543
                                                                        <span class="d-block item-heading--txt--sub">Order #: 1234567</span>
                                                         ...
                                                         <div class="row traveller-block m-0">
                                                            <div class="col-12 px-0 px-md-1">
                                                               <div class="item-order-main px-2">
                                                                  <div class="d-flex item-heading py-xl-2 justify-content-center pb-2 justify-content-lg-start">
                                                                     <div class="col-3 px-1 col-md-3 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Item Name</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">Type</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">Date Paid</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">Amount</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">Action</div>
                                                                  </div>
                                                                  <div class="d-flex item-details py-xl-2 justify-content-center py-2 justify-content-lg-start">
                                                                     <div class="col-3 px-1 col-md-3 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Versailles, France #242543
                                                                        <span class="d-block item-heading--txt--sub">Order #: 1234567</span>
                                                                     ...
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">02/01/2019</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2">01/16/2019</div>
                                                                     <div class="col-2 px-1 col-md-2 item-heading--txt two px-md-1 pl-lg-3 pr-lg-2"><i class="fas fa-eye"></i></div>
                                                                  </div>
                                                                  <div class="d-flex item-details py-xl-2 justify-content-center py-2 justify-content-lg-start">
                                                                     <div class="col-3 px-1 col-md-3 item-heading--txt px-md-1 pl-lg-3 pr-lg-2">Versailles, France #242543
                                                                        <span class="d-block item-heading--txt--sub">Order #: 1234567</span>
                                                   ...
                                                   <div class="col-12 col-md-4 col-lg-4 payment-details-right traveller-details-right confirmation-p-0 pr-md-3 pr-lg-0">
                                                      <div class="traveller-payment-details">
                                                         <div class="traveller-header clearfix pl-4">
                                                            <div class="float-left">
                                                               <h4>Payment
                                                                  <span class="d-inline-block pl-4">Paid by Debit Card</span>
                                                               </h4>
                                                            </div>
                                                         </div>
                                                         <div class="payment-details">
                                                            <div class="px-2 row-payment clearfix">
                                                            ...
                                                            <div class="px-2 row-payment clearfix payment-address">
                                                      ...
                                                      <div class="traveller-payment-details">
                                                         ...
                                                         <div class="payment-plan">
                                                            ...
                                                            <div class="px-2 row-payment clearfix">
                                                               <div class="float-left card-left">First Payment</div>
                                                               <div class="float-right card-right">Dec. 14th, 2019</div>
                                                            </div>
                                                            <div class="px-2 row-payment clearfix">
                                                               <div class="float-left card-left"># of Payments</div>
                                                               <div class="float-right card-right">9</div>
                                                            </div>
                                                            <div class="px-2 row-payment clearfix">
                                                               <div class="float-left card-left">Payment Amount</div>
                                                               <div class="float-right card-right">$340.00</div>
                                                            </div>
                                                         </div>
                                                      </div>
                                                      <div class="payment-total-price px-2">
                                                         <div class="total-price-details">
                                                            ...
                                                            <div class="row-total clearfix">
                                                               <div class="float-left">Next Payment Date</div>
                                                               <div class="float-right">Mar. 16th, 2019</div>
                                                            </div>
                                                            <div class="row-total clearfix total-price">
                                                               <div class="float-left">Next Payment Amount</div>
                                                               <div class="float-right">$199.00</div>
                                                            </div>
                                                         </div>
                                                      </div>
                                                   </div>
               ...
               <div id="usertwo" class="tab-pane">
                  <section class="profile-tab-content">
                     <div class="profile-head d-none d-md-block clearfix">
                        <h2 class="float-left">John Doe | Washington, D.C. 2019</h2>
               ...
               <div id="userthree" class="tab-pane">
                  <section class="profile-tab-content">
                     <div class="profile-head d-none d-md-block clearfix">
                        <h2 class="float-left">Jane Doe | Washington, D.C. 2019</h2>
                        <div class="float-right">
                           <i class="fa fa-envelope" aria-hidden="true"></i><span class="icons">&nbsp;Email</span>&emsp;
                           <i class="fa fa-download" aria-hidden="true"></i><span class="icons">&nbsp;Download</span>&emsp;
                           <i class="fa fa-print" aria-hidden="true"></i><span class="icons">&nbsp;Print</span>
            ...
            <div class="col-12">
<button type="button" class="btn btn-primary payment-due--btn two mr-4">Make A Payment</button>
            </div>
         </div>
      </div>
   </div>
...
<script>
   $(document).ready(function(){
       ...
       $(".m-customer-profile .vertical-tabs-section .nav-link .radio-container").click(function(){
           var a = $(this).text();
