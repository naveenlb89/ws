                    ...
                    <div class="col-sm-12 col-md-9 col-lg-9 welcome-body">
                        ...
                        <div class="row have-account">
                            <div class="col-sm-12 col-md-6 col-lg-6  order-3 order-sm-3 order-md-1 order-lg-1 ">
                                ...
                                <button class="btn-white btn-white-error d-none d-md-block">REGISTER WITH A NEW ACCOUNT</button>
                            </div>
                                ...
                                <form>
                                    ...
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text invalidate"><i class="fas fa-user"></i></span>
                                        </div>
                                        <input type="text" class="form-control invalidate-input">
                                    </div>
                                    <p>Password</p>
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text invalidate"><i class="fas fa-lock-open"></i></span>
                                        </div>
                                        <input type="text" class="form-control invalidate-input">
                                    ...
                                    <div>
                                         <label class="invalid-password">Invalid username or password. Please try again.</label>
                                    </div>
