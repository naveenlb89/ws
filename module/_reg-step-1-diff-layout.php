		...
		<section class="m-reg-form-block traveler-form-block traveler-1">
			...
			<div class="form-head">
				...
				<h2><span>Traveler 1 </span> 
					<span class="traveler-dropdown"><select class="form-control form-control-sm" id="" name="" aria-invalid="false">
			...
			<div class="traveller-form-wrapper collapse show" id="traveller1-form">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3 current-grade hide">
						...
						<select class="form-control form-control-lg" id="travellingas" name="tavellingAs" aria-invalid="false">
