                        ...
                        <div class="col-md-10 profile-right">
                            <section class="m-reg-form-block profile-block">
                                <form action="#">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg" placeholder="Jennie" name="firstname">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row ma-b">  
                                            <div class="col-md-6">
                                                <div class="form-row  ma-b">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <div class="form-row  ma-b">
                                                            <div class="form-group col-md-6 col-6 ma-b">
                                                            <label>Gender</label>
                                                            ...
                                                            <div class="form-group col-md-6 col-6 ma-b">
                                                                ...
                                                                <input type="text" class="form-control form-control-lg profile-dob" name="bday">	
                                                            </div>
                                                        </div>
                                                    </div>  
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        <label>Address</label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="123 North Main Street" name="cityGaurdian">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-row  ma-b">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-row  ma-b">
                                                    ...
                                                    <div class="form-group col-md-3 col-6 ma-b">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-3 col-6"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <section class="emergency-profile-form">
                                        <div class="emergency-row">
                                            <div class="profile-head d-none d-md-block clearfix">
                                                <div class="emergency-profile-head clearfix">
                                                    <div class="emergency-head">
                                                        <h2 class="float-left">Emergency Contact</h2>
                                                    </div>
                                                    <div class="emergency-button">
                                                        <button>Select One <span>+</span></button>
                                                    </div>
                                                </div>
                                                
                                            </div>
                                            <div class="mobile-profile-head d-block d-md-none">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="emergency-form">
                                                        <div class="form-row  ma-b">
                                                            <div class="form-group col-md-9  ma-b">
                                                                <div class="form-row  ma-b">
                                                                    <div class="form-group col-md-4">
                                                                        <label>First Name</label>
                                                                        <input type="text" class="form-control form-control-lg" placeholder="Bill" name="firstname" value="">
                                                                    </div>
                                                                    <div class="form-group col-md-8">
                                                                        <div class="form-row  ma-b">  
                                                                            <div class="form-group col-md-6">
                                                                                <label>Middle Name <span>optional</span></label>
                                                                                <input type="text" class="form-control form-control-lg" placeholder="" name="middlename" value="">
                                                                            </div>
                                                                            <div class="form-group col-md-6">
                                                                                <label>Last Name</label>
                                                                                <input type="text" class="form-control form-control-lg" placeholder="Doe" name="lastname" value="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group col-md-9 ma-b">
                                                                <div class="form-row ma-b">
                                                                    <div class="form-group col-md-4">
                                                                        ...
                                                                        <input type="email" class="form-control form-control-lg" placeholder="BillD@email.com" name="emailEmergencyContact" value="">
                                                                    </div>
                                                                    <div class="form-group col-md-8">
                                                                        <div class="form-row ma-b">
                                                                            <div class="form-group col-md-3">
                                                                        ...
                                                                        <div class="form-row ma-b">
                                                                            ...
                                                                            <div class="form-group col-md-8 ma-b">
                                                                                <div class="form-row ma-b">
                                                                                    <div class="form-group col-md-6 col-lg-3 ma-b">
                                                                                        <span class="add-phone"><i class="fa fa-plus"></i> Add phone</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
