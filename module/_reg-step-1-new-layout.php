		...
		<div class="row">
			...
			<div class="gaurdian-form-wrapper">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-3">
						<label class="error-custom">Parent or Guardian Last Name</label>
						<input type="email" class="form-control form-control-lg error-custom" placeholder="" name="emailGaurdian" aria-invalid="true"><label id="emailGaurdian-error" class="error" for="emailGaurdian">Enter a valid email</label>
					</div>
					<div class="form-group col-md-3">
						<div class="form-row">
							<div class="form-group col-md-6 col-6">
		...
		<section class="m-reg-form-block">
			...
			<div class="emergency-form-wrapper">
				...
				<div class="form-row">
							...
							<div class="form-group col-md-3">
								<label>Retype Email Address</label>
								<input type="email" class="form-control form-control-lg" placeholder="" name="retypeEmailEmergencyContact" value="BillD@email.com" aria-invalid="false">
							</div>
					<div class="form-group col-md-6">
						<div class="form-row">
							<div class="form-group col-md-3 col-6">
