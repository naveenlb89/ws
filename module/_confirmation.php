        ...
        <div class="confirmation-block">
            ...
            <div class="row confirmation-traveller-details">
                <div class="col-12 col-md-8 traveller-details-left confirmation-p-0">
                                    ...
                                    <div class="traveller-details">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">Jennie Doe</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-6 col-md-4 col-form-label">Gender</label>
                                            <div class="col-6 col-md-8 ">
                                                <select class="form-control form-control-lg" id="travellerGender" name="travellerGender" aria-invalid="false">
                                                    <option>Female</option>
                                                    <option>Male</option>
                                                </select>
												<span class="entered-val">Female</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label  class="col-6 col-md-4 col-form-label">DOB</label>
                                            <div class="col-6 col-md-8 ">
                                                <input type="date" class="form-control" value="12/21/1971" name="travellerDOB">
												<span class="entered-val">12/21/1971</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">+1(123) 456-7890</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">+1(123) 456-7898</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">janeD@email.com</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-6 col-md-4 col-form-label">Country</label>
                                            <div class="col-6 col-md-8 ">
                                                <select class="form-control form-control-lg" id="" name="travellerCountry" aria-invalid="false">
                                                    <option>US</option>
                                                    <option>France</option>
                                                    <option>UK</option>
                                                </select>
												<span class="entered-val">USA</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5">
                                    <div class="traveller-details">
                                        ...
                                        <div class="row form-group">
                                            <label  class="col-6 col-md-4 col-form-label">DOB</label>
                                            <div class="col-6 col-md-8 ">
                                                <input type="date" class="form-control" value="4/21/2000" name="travellerDOB">
												<span class="entered-val">4/21/2000</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label  class="col-6 col-md-4 col-form-label">Phone</label>
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">+1(123) 456-7891</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label  class="col-6 col-md-4 col-form-label">Cell</label>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">jennieD@email.com</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-6 col-md-4 col-form-label">Country</label>
                                            <div class="col-6 col-md-8 ">
                                                <select class="form-control form-control-lg" id=""  value="USA" name="travellerCountry" aria-invalid="false">
                                                    <option>US</option>
                                                    <option>France</option>
                                                    <option>UK</option>
                                                </select>
                    ...
                    <div class="traveller traveller-parent saved">
                        <form name="traveller-1" action="">
                            <div class="traveller-header clearfix">
                                <div class="float-left ">
                                    ...
                                    <div class="traveller-details">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">Jim Doe</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-6 col-md-4 col-form-label">Gender</label>
                                    ...
                                    <div class="traveller-details">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">Jim Write</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <label class="col-6 col-md-4 col-form-label">Email</label>
                                            <div class="col-6 col-md-8 ">
												...
												<span class="entered-val">jwrite@email.com</span>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                ...
                <div class="col-12 col-md-4 traveller-details-right confirmation-p-0 1">
                    <div class="traveller-payment-details">
                        <div class="traveller-header clearfix">
                            ...
                            <div class="float-right">
                                ...
                                <a href="./_card-payment.php"><span class="editing"><i class="fa fa-edit"></i> Edit</span></a>
                            </div>
                        </div>
                    ...
                    <div class="traveller-payment-details">
                        <div class="traveller-header clearfix">
                            ...
                            <div class="float-right">
                                <span class="saving"><i class="fa fa-save"></i> Save</span>
                                <a href="./_payment.php"><span class="editing"><i class="fa fa-edit"></i> Edit</span></a>
                            </div>
                        </div>
...
$(document).ready(function(){
  ...
  $(".saving").click(function(){
	if(!$(".traveller-details input,.traveller-details select").hasClass("error-custom")){
		$(this).closest(".traveller").removeClass("edit").addClass("saved");
	}
  });
});
</script>
